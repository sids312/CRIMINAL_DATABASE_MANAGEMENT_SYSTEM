...
void loading();     // function for loading effect
...
int login()
{
	...
	cout<<"\t\t\t\t******************************************";
	cout<<"\n";
	cout<<"\t\t\t\t | CRIMINAL DATA BASE MANAGEMENT SYSTEM |";
	cout<<"\t\t\t\t\t******************************************";
	cout<<"\n\n";
	cout<<"\t\t\t\t";
	cout<<"USERNAME :";
	...
	cout<<"PASSWORD :";
	cin>>password;
	if(username=="siddu" && password=="siddu123")
	{
		cout<<"\n\t\t\t\t Now You Can Have The Access To The System"<<endl;
		system("pause");
        system("cls");
        true1 = 0;
        return 1;
	...
	else
	{
		...
		temp++;
		cout<<"\n\t\t\t\t";
		cout<<"IN VALID DATA !PLEASE ENTER THE CORRECT DATA . "<<endl;
		cout<<"\n\t\t\t\t";
        cout << "No. of attempts remain:" << 4-temp<<endl;
        system("pause");
         if(temp>=4)
        {
          cout << "\n\n\t\t\t";
          ...
          cout << "\t\t\t";
          cout<<"YOU CANT ACCESS THE DATA !!"<<endl;
          system("pause");
          callExit();
        }
...
void mainpage()
{
	...
	cout<<"\t\t\t\t\t******************************************";
	cout<<"\n\n\t\t\t";
	cout <<"Prepared by :VAGHMARE SIDDHARTH CO21365 \n"<<endl;
	cout<<"\t\t\t";
	cout <<"C++ Project :CRIMINAL DATA BASE MANAGEMENT SYSTEM \n\n"<<endl;
	system("pause");
	cout<<"\n\n";
	loading();
...
void callExit()
{
	system("cls");
	cout<<"\n\n\n\n\n";
	cout << "\n\t\t\t\tTaking You Out of The System...."<<endl;
	cout<<"\n\t";
	loading();
	system("cls");
...
void menu(criminal l)
{
  ...
  while(true)
  {
    ...
    cout << "\n";
    cout << "\t\t\t\t    -------------------------------------\n";
    cout << "\t\t\t\t    |CRIMINAL DATABASE MANAGEMENT SYSTEM|\n";
    cout << "\t\t\t\t    --------------------------------------\n";
    cout << "\n\n\n\n";
    cout << "\t\t\t\t";
    cout << " 1. ADD RECORD\n\n";
